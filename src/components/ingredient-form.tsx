    ...
    >
      ...
      {sec === "allergens" && (
        <fieldset>
          ...
          <div className="border border-[color:var(--ds-border-warm)] rounded-[4px] overflow-hidden">
            <div className="px-3 py-2 bg-muted flex items-center justify-between gap-2">
