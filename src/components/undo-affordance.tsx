...
export function UndoAffordance() {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 z-40 flex items-center gap-2 rounded-[6px] border-[0.5px] border-[color:var(--ds-border-warm)] bg-[color:var(--ds-card-bg)] shadow-lg px-3 py-2 text-xs font-medium hover:border-primary hover:text-primary transition-colors disabled:opacity-50"
    >
