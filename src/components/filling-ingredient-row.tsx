        ...
        <>
          <div className="flex items-center gap-1">
            <input
              ...
              className="w-20 rounded-[6px] border-[0.5px] border-[color:var(--ds-border-warm)] bg-[color:var(--ds-card-bg)] px-2 py-1 text-sm text-right focus:outline-none focus:ring-2 focus:ring-primary"
            />
          ...
          <input
            ...
            placeholder="note…"
            aria-label="Note"
            className="w-28 rounded-[6px] border border-transparent bg-transparent px-2 py-1 text-xs text-muted-foreground placeholder:text-muted-foreground/40 hover:border-[color:var(--ds-border-warm)] focus:border-[color:var(--ds-border-warm)] focus:outline-none focus:ring-2 focus:ring-primary"
          />
          {pendingRemove ? (
