      ...
      <div className="relative w-full max-w-md mx-4 mb-4 sm:mb-0 rounded-sm border border-border bg-card shadow-xl overflow-hidden">
        ...
        <div className="px-5 py-4 border-t border-border flex gap-2 justify-end">
          <button
            onClick={onCancel}
            disabled={busy}
            className="rounded-sm border border-border bg-card px-4 py-2 text-sm text-muted-foreground hover:text-foreground hover:border-foreground/30 disabled:opacity-50"
          >
            Cancel
          </button>
          <button
