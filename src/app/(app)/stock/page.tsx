    ...
    <div className="px-4 pb-8 space-y-3">
      <div className="flex gap-2">
        ...
        <button
          ...
          className={`relative rounded-[4px] border p-2 transition-colors ${showFilters ? "bg-primary text-primary-foreground border-primary" : "border-[color:var(--ds-border-warm)] bg-background"}`}
          aria-label="Filters"
        >
          <SlidersHorizontal className="w-5 h-5" />
          {activeFilterCount > 0 && (
            <span className="absolute -top-1 -right-1 w-4 h-4 rounded-[4px] bg-primary text-primary-foreground text-[10px] font-bold flex items-center justify-center">
              {activeFilterCount}
            </span>
          )}
        </button>
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="min-w-0">
                  <p className="font-semibold text-sm truncate flex items-center gap-1.5 flex-wrap">
                    ...
                    {(() => {
                      ...
                      return (
                        <span className={`shrink-0 rounded-[4px] border ${pillCls} px-1.5 py-0 text-[10px] font-semibold tabular-nums inline-flex items-center gap-0.5`}>
                          {group.totalProducts} pcs
                        </span>
                      );
                    })()}
                    {group.isLow && (
                      <span className="shrink-0 rounded-[4px] border border-status-warn-edge bg-status-warn-bg text-status-warn px-1.5 py-0 text-[10px] font-semibold uppercase tracking-wide">
                        Low
                      </span>
                    )}
                    {group.frozenProducts > 0 && (
                      <span className="shrink-0 rounded-[4px] border border-sky-200 bg-sky-50 text-sky-700 px-1.5 py-0 text-[10px] font-semibold inline-flex items-center gap-0.5">
                    ...
                    return (
                      <div className="flex items-center gap-1 flex-wrap mt-1">
                        {STOCK_LOCATIONS.map((loc) => {
                          ...
                          if (editing) {
                            return (
                              <span key={loc} className={`rounded-[4px] border px-1.5 py-0 text-[10px] font-medium inline-flex items-center gap-1 ${cls}`}>
                          ...
                          return (
                            <button
                              ...
                              className={`rounded-[4px] border px-1.5 py-0 text-[10px] font-medium tabular-nums inline-flex items-center gap-0.5 hover:border-primary transition-colors ${cls}`}
                ...
                {countingProductId !== group.productId && (
                  <button
                    ...
                    className="shrink-0 inline-flex items-center gap-1 rounded-[4px] border border-[color:var(--ds-border-warm)] bg-background px-2 py-1 text-[11px] font-medium text-muted-foreground hover:border-primary hover:text-primary transition-colors"
                    ...
                    <div className="px-3 py-2.5 flex items-start justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1.5 shrink-0 pt-0.5">
                        <button
                          ...
                          className="rounded-[4px] border border-[color:var(--ds-border-warm)] px-2 py-0.5 text-[10px] font-medium text-muted-foreground hover:border-foreground hover:text-foreground transition-colors inline-flex items-center gap-0.5"
                        ...
                        <button
                          ...
                          className="rounded-[4px] border border-[color:var(--ds-border-warm)] px-2 py-0.5 text-[10px] font-medium text-sky-700 hover:border-sky-500 hover:bg-sky-50 transition-colors inline-flex items-center gap-0.5"
                        ...
                        <button
                          ...
                          className="rounded-[4px] border border-[color:var(--ds-border-warm)] px-2 py-0.5 text-[10px] font-medium text-muted-foreground hover:border-foreground hover:text-foreground transition-colors"
                        >
                          Gone
                        </button>
                      </div>
                    ...
                    <div className={`px-3 py-2.5 flex items-start justify-between gap-2 bg-sky-50/40 ${availableCount > 0 ? "border-t border-[color:var(--ds-border-warm)]" : ""}`}>
                      ...
                      <div className="flex items-center gap-1.5 shrink-0 pt-0.5">
                        <button
                          ...
                          className="rounded-[4px] border border-sky-200 bg-white px-2 py-0.5 text-[10px] font-medium text-sky-700 hover:bg-sky-100 transition-colors"
                        >
                          Defrost
                        </button>
                      </div>
    ...
    <div className="px-4 pb-8 space-y-3">
      <div className="flex gap-2">
        ...
        <button
          ...
          className="rounded-[4px] border border-[color:var(--ds-border-warm)] bg-background p-2 transition-colors hover:bg-muted"
        ...
        <div className="rounded-[6px] border-[0.5px] border-[color:var(--ds-border-warm)] bg-[color:var(--ds-card-bg)] p-3 space-y-2">
          ...
          <div className="flex gap-2 justify-end pt-1">
            ...
            <button
              ...
              className="rounded-[4px] bg-accent text-accent-foreground px-3 py-1.5 text-xs font-medium disabled:opacity-50"
            >
              Add
            </button>
          </div>
                    ...
                    {entry.frozen ? (
                      ...
                      <>
                        ...
                        <button
                          ...
                          className="rounded-[4px] border border-[color:var(--ds-border-warm)] px-2 py-0.5 text-[10px] font-medium text-muted-foreground hover:border-status-alert hover:text-status-alert transition-colors"
                        >
                          Discard
                        </button>
                      </>
